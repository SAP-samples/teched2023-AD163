...
- [Exercise 2 - Create Process](exercises/ex2/)
    ...
    - [Exercise 2.4 - Create Approval Sub-Process](exercises/ex2#exercise-24-sub-exercise-2-description)
      - [Exercise 2.2.2 - Add Decision to Determine Approver List](exercises/ex2#exercise-24-sub-exercise-2-description)
      - [Exercise 2.2.3 - Add Approver Form with Sales Order Items Table](exercises/ex2#exercise-24-sub-exercise-2-description)
