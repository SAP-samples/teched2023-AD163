...
- [Exercise 2 - Create Process](exercises/2_CreateProcess/)
    ...
    - [Exercise 2.4 - Create Approval Sub-Process](exercises/2_CreateProcess#create-approval-sub-process-)
      - [Exercise 2.4.1 - Add Decision to Determine Approver List](exercises/2_CreateProcess#add-decision-to-determine-approver-list-)
      - [Exercise 2.4.2 - Add Approver Form with Sales Order Items Table](exercises/2_CreateProcess#add-approver-form-with-sales-order-items-table-)
    - [Exercise 2.5 - Add Condition](exercises/2_CreateProcess#add-condition-)
    - [Exercise 2.6 - Add Action to read Sales Order Header ](exercises/2_CreateProcess#add-action-to-read-sales-order-header-)
    - [Exercise 2.7 - Add Action to Update Sales Order](exercises/2_CreateProcess#add-action-to-update-sales-order-)
    - [Exercise 2.8 - Add Approval and Rejection Notifications](exercises/2_CreateProcess#add-approval-and-rejection-notifications-)
